...
import followProductsController from "./06-Controllers/follow-products-controller";
import path from "path";
import socketLogic from './05-BLL/socket-logic';
import prodctSocketLogic from './05-BLL/product-socket-logic';
...
expressServer.use("/api/products/follow", followProductsController);
...
prodctSocketLogic.initSocketIo(httpServer);
